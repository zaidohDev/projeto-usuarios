class UserController{
    ...
    onEdit(){
        ...
        this.formUpdateEl.addEventListener('submit', e =>{
            ...
            let tr = this.tableIdEl.rows[index];
    ...
    onSubmit(){
        ...
        this.formCreateEl.addEventListener('submit', event => {
            ...
            this.getPhotos(this.formCreateEl).then(
    ...
    updateCount(){
        ...
        [...this.tableIdEl.children].forEach(tr => {
